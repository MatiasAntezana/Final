...
def organization():
    ...
    """
    with open("Audio.txt","r") as debussy:
        list_1 = []
        list_org = []
        for line in debussy:
            line = line.strip()
...
def condicion(notes1=['G4','A4', 'B4', 'C5', 'D5', 'E5', 'F5', 'G5', 'A5','B5', 'C6', 'D6', 'E6', 'F6', 'G6', 'A6', 'B6', 'C7','C8']):
    return notes1 

WHITE_MAPPING=['G4','A4', 'B4', 'C5', 'D5', 'E5', 'F5', 'G5', 'A5','B5', 'C6', 'D6', 'E6', 'F6', 'G6', 'A6', 'B6', 'C7']

filtrada= [elemento for elemento in WHITE_MAPPING if condicion(elemento)]
print(filtrada)
